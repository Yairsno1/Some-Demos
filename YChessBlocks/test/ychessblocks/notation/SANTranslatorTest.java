 ...
 * @author Yair
 */
public class SANTranslatorTest 
{
  ...
  /**
   * Test of getFileNotation method, of class SANTranslator.
   */
  @Test
  public void testGetFileNotation() 
  {
    System.out.println("getFileNotation");
    
    String expResult;
    String result;
    SANTranslator instance = NotationTranslator.getInstance().getStandradAlgebricNotationTranslator();
    
    expResult = "a";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEa));
    assertEquals(expResult, result);
    
    expResult = "b";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEb));
    assertEquals(expResult, result);

    expResult = "c";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEc));
    assertEquals(expResult, result);

    expResult = "d";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEd));
    assertEquals(expResult, result);

    expResult = "e";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEe));
    assertEquals(expResult, result);
    
    expResult = "f";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEf));
    assertEquals(expResult, result);

    expResult = "g";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEg));
    assertEquals(expResult, result);

    expResult = "h";
    result = instance.getFileNotation(m_board.getFile(IFile.ChessboardFile.FILEh));
    assertEquals(expResult, result);    
  }

  /**
   * Test of getRankNotation method, of class SANTranslator.
   */
  @Test
  public void testGetRankNotation()
  {
    System.out.println("getRankNotation");
    ...
    expResult = "1";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK1));
    assertEquals(expResult, result);
    
    expResult = "2";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK2));
    assertEquals(expResult, result);

    expResult = "3";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK3));
    assertEquals(expResult, result);
    
    expResult = "4";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK4));
    assertEquals(expResult, result);

    expResult = "5";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK5));
    assertEquals(expResult, result);
    
    expResult = "6";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK6));
    assertEquals(expResult, result);

    expResult = "7";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK7));
    assertEquals(expResult, result);
    
    expResult = "8";
    result = instance.getRankNotation(m_board.getRank(IRank.ChessboardRank.RANK8));
    assertEquals(expResult, result);    
  }

  /**
   * Test of getSquareNotation method, of class SANTranslator.
   */
  @Test
  ...
  /**
   * Test of getPieceNotation method, of class SANTranslator.
   */
  @Test
